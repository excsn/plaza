...
//! resolution of 1/256 of a unit, which is four times finer than a pixel at any
//! sane zoom. Floats appear in exactly one place, [`Fx::to_f32`], which the
//! renderer calls and the simulation never does.
...
/// A point, in whatever unit [`Fx`] is carrying.
