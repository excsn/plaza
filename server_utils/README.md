...
- **Leaving**: `leave_group` for a player leaving a party, `remove` for one leaving the world, and they are not the same event. The first keeps your spectators; the second returns everyone who has to be told you are gone. Both dissolve a group of one rather than keeping it.
