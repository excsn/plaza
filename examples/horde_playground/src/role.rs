...
pub enum Role {
  ...
  Headless,
  /// Server with a window and the full control panel, but no player of your own.
...
impl Role {
  ...
  /// Whether this process drives a player of its own.
...
impl Default for Role {
  fn default() -> Self {
    ...
    // and called `process::exit`, which in wasm is a trap.
