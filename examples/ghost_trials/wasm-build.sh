...
cp "$CARGO_TARGET_DIR/wasm32-unknown-unknown/release/ghost_trials.wasm" "$here/static/ghost_trials.wasm"
...
if command -v wasm-opt >/dev/null 2>&1; then
  ...
  wasm-opt -Oz "$here/static/ghost_trials.wasm" -o "$here/static/ghost_trials.wasm"
fi
